    ...
    <footer className="bg-zinc-900 text-white">
      ...
      <div className="flex lg:flex-row md:flex-col sm-flex-col flex-col lg:gap-36 md:gap-20 sm:gap-10 gap-5 justify-center items-center text-center pt-2 text-gray-400 text-sm pb-8">
        ...
        <span className="flex flex-row gap-5">
          <a href=""><Icon icon={facebook} size="1.5rem"/></a>
          <a href=""><Icon icon={google} size="1.5rem"/></a>
          <a href=""><Icon icon={instagram} size="1.5rem"/></a>
          <a href=""><Icon icon={telegram} size="1.5rem"/></a>
          <a href=""><Icon icon={github} size="1.5rem"/></a>
